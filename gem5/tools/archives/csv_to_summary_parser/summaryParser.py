...
l2ConfigSpace = ['64kB_4','128kB_4','128kB_8','256kB_4','256kB_8','256kB_16']
...
def initCSVList():
	...
	l2ConfigSpaceSize = len(getPossibleCacheConfigs(L2_CACHE_CONFIG_SPACE, 64))
...
def getExhaustiveHeuristic():
	...
	L2_CONFIGS = getPossibleCacheConfigs(L2_CACHE_CONFIG_SPACE, 64)
